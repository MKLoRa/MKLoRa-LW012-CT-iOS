...
@interface MKAEStandbyModeModel ()
...
@implementation MKAEStandbyModeModel
...
- (BOOL)readStrategy {
    ...
    [MKAEInterface ae_readStandbyModePositioningStrategyWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configStrategy {
    __block BOOL success = NO;
    [MKAEInterface ae_configStandbyModePositioningStrategy:self.strategy sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
