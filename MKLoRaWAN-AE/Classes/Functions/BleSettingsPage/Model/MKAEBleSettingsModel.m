...
@interface MKAEBleSettingsModel ()
...
@implementation MKAEBleSettingsModel
...
- (BOOL)readAdvName {
    ...
    [MKAEInterface ae_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvName {
    __block BOOL success = NO;
    [MKAEInterface ae_configDeviceName:self.advName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBroadcastTimeout {
    __block BOOL success = NO;
    [MKAEInterface ae_readBroadcastTimeoutWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBroadcastTimeout {
    __block BOOL success = NO;
    [MKAEInterface ae_configBroadcastTimeout:[self.timeout integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readNeedPassword {
    __block BOOL success = NO;
    [MKAEInterface ae_readConnectationNeedPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNeedPassword {
    __block BOOL success = NO;
    [MKAEInterface ae_configNeedPassword:self.needPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTxPower {
    __block BOOL success = NO;
    [MKAEInterface ae_readTxPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTxPower {
    __block BOOL success = NO;
    [MKAEInterface ae_configTxPower:self.txPower sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readAdvInterval {
    __block BOOL success = NO;
    [MKAEInterface ae_readAdvIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvInterval {
    __block BOOL success = NO;
    [MKAEInterface ae_configAdvInterval:[self.interval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readBeaconMode {
    __block BOOL success = NO;
    [MKAEInterface ae_readBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configBeaconMode {
    __block BOOL success = NO;
    [MKAEInterface ae_configBeaconStatus:self.beaconMode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
