//
//  MKAEFilterByAdvNameController.m
...
@interface MKAEFilterByAdvNameController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAEFilterByAdvNameModel *dataModel;

@end

@implementation MKAEFilterByAdvNameController

- (void)dealloc {
    NSLog(@"MKAEFilterByAdvNameController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AE", @"MKAEFilterByAdvNameController", @"ae_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAEFilterByAdvNameModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAEFilterByAdvNameModel alloc] init];
    }
    return _dataModel;
}
