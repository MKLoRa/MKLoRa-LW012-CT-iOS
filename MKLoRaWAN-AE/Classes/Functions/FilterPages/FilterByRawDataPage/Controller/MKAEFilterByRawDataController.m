...
#import "MKAEFilterByUIDController.h"
#import "MKAEFilterByURLController.h"
#import "MKAEFilterByTLMController.h"
#import "MKAEFilterByBXPButtonController.h"
#import "MKAEFilterByBXPTagController.h"
#import "MKAEFilterByPirController.h"
#import "MKAEFilterByTofController.h"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0) {
        //iBeacon
        MKAEFilterByBeaconController *vc = [[MKAEFilterByBeaconController alloc] init];
        vc.pageType = mk_ae_filterByBeaconPageType_beacon;
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 0 && indexPath.row == 1) {
        //Eddystone-UID
        MKAEFilterByUIDController *vc = [[MKAEFilterByUIDController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 0 && indexPath.row == 2) {
        //Eddystone-URL
        MKAEFilterByURLController *vc = [[MKAEFilterByURLController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 0 && indexPath.row == 3) {
        //Eddystone-TLM
        MKAEFilterByTLMController *vc = [[MKAEFilterByTLMController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 0 && indexPath.row == 4) {
        //BXP-iBeacon
        MKAEFilterByBeaconController *vc = [[MKAEFilterByBeaconController alloc] init];
        vc.pageType = mk_ae_filterByBeaconPageType_bxpBeacon;
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 2 && indexPath.row == 0) {
        //BXP-Button
        MKAEFilterByBXPButtonController *vc = [[MKAEFilterByBXPButtonController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 2 && indexPath.row == 1) {
        //BXP - Tag
        MKAEFilterByBXPTagController *vc = [[MKAEFilterByBXPTagController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 2 && indexPath.row == 2) {
        //MK-PIR
        MKAEFilterByPirController *vc = [[MKAEFilterByPirController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 2 && indexPath.row == 3) {
        //MK-TOF
        MKAEFilterByTofController *vc = [[MKAEFilterByTofController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 2 && indexPath.row == 4) {
        //Other
        MKAEFilterByOtherController *vc = [[MKAEFilterByOtherController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
}
