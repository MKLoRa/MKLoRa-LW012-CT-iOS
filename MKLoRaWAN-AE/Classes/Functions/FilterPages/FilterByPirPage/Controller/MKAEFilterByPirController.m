...
@interface MKAEFilterByPirController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAEFilterByPirModel *dataModel;

@end

@implementation MKAEFilterByPirController

- (void)dealloc {
    NSLog(@"MKAEFilterByPirController销毁");
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 0) {
        ...
        self.dataModel.delayStatus = dataListIndex;
        return;
    }
    if (index == 1) {
    ...
    if (index == 3) {
        //Detection Status
        self.dataModel.detection = dataListIndex;
        return;
    }
}
...
- (void)loadSection1Datas {
    ...
    cellModel1.dataListIndex = self.dataModel.delayStatus;
    ...
    cellModel3.dataListIndex = self.dataModel.sensitivity;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AE", @"MKAEFilterByPirController", @"ae_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAEFilterByPirModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAEFilterByPirModel alloc] init];
    }
    return _dataModel;
}
