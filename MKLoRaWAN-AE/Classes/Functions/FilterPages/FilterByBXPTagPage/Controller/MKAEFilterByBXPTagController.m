//
//  MKAEFilterByBXPTagController.m
...
#import "MKAEFilterByBXPTagController.h"
...
@interface MKAEFilterByBXPTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAEFilterByBXPTagModel *dataModel;

@end

@implementation MKAEFilterByBXPTagController

- (void)dealloc {
    NSLog(@"MKAEFilterByBXPTagController销毁");
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section == 2) {
        MKAEFilterEditSectionHeaderViewModel *headerModel = [[MKAEFilterEditSectionHeaderViewModel alloc] init];
        headerModel.index = 0;
...
- (void)mk_ae_filterEditSectionHeaderView_addButtonPressed:(NSInteger)index {
    ...
    cellModel.msg = [NSString stringWithFormat:@"Tag ID %ld",(long)(self.section2List.count + 1)];
...
- (void)loadSection1Datas {
    ...
    cellModel1.index = 1;
    cellModel1.msg = @"Precise Match Tag ID";
    ...
    cellModel2.index = 2;
    cellModel2.msg = @"Reverse Filter Tag ID";
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AE", @"MKAEFilterByBXPTagController", @"ae_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAEFilterByBXPTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAEFilterByBXPTagModel alloc] init];
    }
    return _dataModel;
}
