...
#import "MKAEFilterByBeaconDefines.h"

NS_ASSUME_NONNULL_BEGIN

@interface MKAEFilterByBeaconModel : NSObject

@property (nonatomic, assign)mk_ae_filterByBeaconPageType pageType;
