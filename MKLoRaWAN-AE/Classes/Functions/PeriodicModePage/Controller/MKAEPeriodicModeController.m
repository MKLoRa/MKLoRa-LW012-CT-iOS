...
@interface MKAEPeriodicModeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAEPeriodicModeModel *dataModel;

@end

@implementation MKAEPeriodicModeController

- (void)dealloc {
    NSLog(@"MKAEPeriodicModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AE", @"MKAEPeriodicModeController", @"ae_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAEPeriodicModeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAEPeriodicModeModel alloc] init];
    }
    return _dataModel;
}
