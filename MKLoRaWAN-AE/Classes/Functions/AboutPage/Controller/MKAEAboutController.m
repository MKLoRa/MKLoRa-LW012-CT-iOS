...
@implementation MKAEAboutController

- (void)dealloc {
    NSLog(@"MKAEAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-AE", @"MKAEAboutController", @"ae_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-AE", @"MKAEAboutController", @"ae_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
