...
@interface MKAEBatteryConsumptionModel ()
...
@implementation MKAEBatteryConsumptionModel
...
- (BOOL)readCurrent {
    ...
    [MKAEInterface ae_readBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readLast {
    __block BOOL success = NO;
    [MKAEInterface ae_readLastCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readAll {
    __block BOOL success = NO;
    [MKAEInterface ae_readAllCycleBatteryInformationWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
