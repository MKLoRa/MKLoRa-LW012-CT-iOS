...
@implementation MKAEPCBAStatusCellModel
@end

@interface MKAEPCBAStatusCell ()
...
@implementation MKAEPCBAStatusCell

+ (MKAEPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKAEPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAEPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKAEPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAEPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKAEPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKAEPCBAStatusCellModel.class]) {
        return;
    }
