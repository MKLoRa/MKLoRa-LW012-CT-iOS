...
@implementation MKAESelftestCellModel
@end

@interface MKAESelftestCell ()
...
@implementation MKAESelftestCell

+ (MKAESelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKAESelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAESelftestCellIdenty"];
    if (!cell) {
        cell = [[MKAESelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAESelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKAESelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKAESelftestCellModel.class]) {
        return;
    }
