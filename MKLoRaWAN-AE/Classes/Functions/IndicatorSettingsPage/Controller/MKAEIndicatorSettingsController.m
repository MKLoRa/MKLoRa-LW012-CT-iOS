//
//  MKAEIndicatorSettingsController.m
...
@interface MKAEIndicatorSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAEIndicatorSettingsModel *dataModel;

@end

@implementation MKAEIndicatorSettingsController

- (void)dealloc {
    NSLog(@"MKAEIndicatorSettingsController销毁");
}
...
- (void)loadSection1Datas {
    MKTextSwitchCellModel *cellModel2 = [[MKTextSwitchCellModel alloc] init];
    cellModel2.index = 2;
    cellModel2.msg = @"Bluetooth Broadcast";
    cellModel2.isOn = self.dataModel.Broadcast;
    [self.section1List addObject:cellModel2];
    
    MKTextSwitchCellModel *cellModel3 = [[MKTextSwitchCellModel alloc] init];
    cellModel3.index = 3;
    cellModel3.msg = @"Network Check";
    cellModel3.isOn = self.dataModel.NetworkCheck;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AE", @"MKAEIndicatorSettingsController", @"ae_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAEIndicatorSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAEIndicatorSettingsModel alloc] init];
    }
    return _dataModel;
}
