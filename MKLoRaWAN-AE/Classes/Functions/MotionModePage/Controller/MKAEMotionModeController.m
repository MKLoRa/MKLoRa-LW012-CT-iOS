...
@interface MKAEMotionModeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKAEMotionModeModel *dataModel;

@end

@implementation MKAEMotionModeController

- (void)dealloc {
    NSLog(@"MKAEMotionModeController销毁");
}
...
- (void)mk_deviceTextCellValueChanged:(NSInteger)index textValue:(NSString *)value {
    ...
    if (index == 5) {
        ...
        cellModel.textFieldValue = value;
        self.dataModel.reportIntervalOnStationary = value;
        return;
    }
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 3) {
        ...
        cellModel.dataListIndex = dataListIndex;
        self.dataModel.posStrategyOnStationary = dataListIndex;
        return;
    }
}
...
- (void)configMotionModeEvents:(BOOL)isOn index:(NSInteger)index {
    if (index == 0) {
        ...
        self.dataModel.fixOnStationary = isOn;
    }else if (index == 4) {
...
- (void)loadSection9Datas {
    ...
    cellModel.isOn = self.dataModel.fixOnStationary;
...
- (void)loadSection10Datas {
    ...
    cellModel.maxLength = 5;
    cellModel.unit = @"Mins";
    cellModel.textFieldValue = self.dataModel.reportIntervalOnStationary;
...
- (void)loadSection11Datas {
    ...
    cellModel.dataList = @[@"BLE",@"GPS",@"BLE+GPS",@"BLE*GPS"];
    cellModel.dataListIndex = self.dataModel.posStrategyOnStationary;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-AE", @"MKAEMotionModeController", @"ae_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKAEMotionModeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKAEMotionModeModel alloc] init];
    }
    return _dataModel;
}
