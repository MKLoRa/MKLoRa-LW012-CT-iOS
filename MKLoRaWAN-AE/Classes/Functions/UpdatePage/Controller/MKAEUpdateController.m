...
@interface MKAEUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKAEDFUModule *dfuModule;
...
@implementation MKAEUpdateController

- (void)dealloc {
    NSLog(@"MKAEUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ae_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKAECentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ae_centralDeallocNotification" object:nil];
...
- (MKAEDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKAEDFUModule alloc] init];
    }
    return _dfuModule;
}
