...
@interface MKAEDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKAEDFUModule

- (void)dealloc{
    NSLog(@"MKAEDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKAECentralManager shared].peripheral];
}
