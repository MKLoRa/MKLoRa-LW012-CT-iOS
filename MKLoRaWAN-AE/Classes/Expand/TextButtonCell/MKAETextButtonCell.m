...
@implementation MKAETextButtonCellModel
@end

@interface MKAETextButtonCell ()
...
@implementation MKAETextButtonCell

+ (MKAETextButtonCell *)initCellWithTableView:(UITableView *)tableView {
    MKAETextButtonCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKAETextButtonCellIdenty"];
    if (!cell) {
        cell = [[MKAETextButtonCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKAETextButtonCellIdenty"];
    }
    return cell;
}
...
- (void)rightButtonPressed {
    if ([self.delegate respondsToSelector:@selector(ae_textButtonCell_buttonAction:)]) {
        [self.delegate ae_textButtonCell_buttonAction:self.dataModel.index];
    }
}

#pragma mark - setter
- (void)setDataModel:(MKAETextButtonCellModel *)dataModel {
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKAETextButtonCellModel.class]) {
        return;
    }
