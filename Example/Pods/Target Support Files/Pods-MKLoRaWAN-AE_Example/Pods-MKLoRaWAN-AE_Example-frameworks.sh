...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKFilterPagesModule/MKFilterPagesModule.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MKLoRaWAN-AE/MKLoRaWAN_AE.framework"
